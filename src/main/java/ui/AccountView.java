        ...
        if (resultOfChoice.isPresent())
        {
            ...
            if (resultOfChoice.get().equals("Payment"))
            {
                ...
                dialog.showAndWait().ifPresent(result -> {
                    ...
                    {
                        alert("Transaktion existiert bereits!");
                    } catch (AccountDoesNotExistException e)
                    {
                        alert("Account nicht gefunden!");
                    } catch (TransactionAttributeException e)
                    {
                        alert("Betrag muss zwischen 0 und 1 sein!");
                    } catch(IOException e)
                    {
                        alert("Fehler beim speichern von der Transaction");
                    }
                });
            ...
            } else
            {
                ...
                dialog.showAndWait().ifPresent(result -> {
                    ...
                    } else if (recipient.getText().equals(MainView.getSelected()))
                    {
                    ...
                    }   else if (recipient.getText().equals(MainView.getSelected()) && sender.getText().equals(MainView.getSelected()))
                    {
                        alert("Sender oder Empfänger sind nicht gleich Account Name!");
                    }
                });
            }
